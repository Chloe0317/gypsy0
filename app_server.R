...
spath <- file.path('/data/www/scripts', '0001Functions.R')
...
ui <- fluidPage(             
  ...
  # footer = includeHTML("/data/www/scripts/footer.html"),
  windowTitle = 'Gypsy',
  navbarPage(title = 'Gypsy',
             ...
             tabPanel("Home",
                      ...
                      # includeHTML("/data/www/scripts/footer.html")
             ),
...
fesp <- list.files('/data/www/data/ESP/', full.names = T)
esp.r <- stack(fesp)
cec.r <- stack('/data/www/data/CEC/CEC_NGR.tif')
